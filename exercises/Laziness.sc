...
// Exercise 5.13
Stream(1,2,3,4,5).mapViaUnfold(f => f + 99).toList//> res18: List[Int] = List(100, 101, 102, 103, 104)
...
Stream.empty zipAll Stream.empty take(10) toList  //> res25: List[(Option[Nothing], Option[Nothing])] = List()

Stream(1,2,3).startsWith(Stream(2))               //> res26: Boolean = false

Stream(1,2,3).tails.toList                        //> res27: List[fpinscala.laziness.Stream[Int]] = List(Cons(<function0>,<functi
                                                  //| on0>), Cons(<function0>,<function0>), Cons(<function0>,<function0>), Empty)
                                                  //| 
Stream(1,2,3).tails.toList                        //> res28: List[fpinscala.laziness.Stream[Int]] = List(Cons(<function0>,<functi
                                                  //| on0>), Cons(<function0>,<function0>), Cons(<function0>,<function0>), Empty)
                                                  //| 
